 ...
 * Класс представляет собой сервис добавления коментариев и уведомлений
 * */
...
public class AppService {
    ...
    public void sleepAndRandomThrowRuntimeException(int seconds, int exceptionProbabilityProc) throws RuntimeException {
        try {
